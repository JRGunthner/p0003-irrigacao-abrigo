...
#define BME280_BUS_WR_PARAM_TYPES uint8_t, uint8_t, uint8_t *, uint8_t
...
*/
#define BME280_BUS_RD_PARAM_TYPES (uint8_t, uint8_t, uint8_t *, uint8_t)
...
#define BME280_CTRL_HUMIDITY_REG    0xF2 // Ctrl Humidity Registe
...
/****************************************************/
/**\name	BIT MASK, LENGTH AND POSITION DEFINITIONS FOR TEMPERATURE OVERSAMPLING  */
/***************************************************/
...
/****************************************************/
/**\name	BIT MASK, LENGTH AND POSITION DEFINITIONS FOR PRESSURE OVERSAMPLING  */
/***************************************************/
...
/****************************************************/
/**\name	BIT MASK, LENGTH AND POSITION DEFINITIONS FOR POWER MODE  */
/***************************************************/
...
/****************************************************/
/**\name	BIT MASK, LENGTH AND POSITION DEFINITIONS FOR HUMIDITY OVERSAMPLING  */
/***************************************************/
...
/****************************************************/
/**\name	BIT MASK, LENGTH AND POSITION DEFINITIONS FOR STANDBY TIME  */
/***************************************************/
...
/****************************************************/
/**\name	BIT MASK, LENGTH AND POSITION DEFINITIONS FOR FILTER */
/***************************************************/
...
/****************************************************/
/**\name	BIT MASK, LENGTH AND POSITION DEFINITIONS FOR SPI ENABLE  */
/***************************************************/
...
/****************************************************/
/**\name	BIT MASK, LENGTH AND POSITION DEFINITIONS FOR PRESSURE AND TEMPERATURE DATA  */
/***************************************************/
/* Data Register */
...
/**\name	BUS READ AND WRITE FUNCTION POINTERS */
/***************************************************/
#define BME280_WR_FUNC_PTR int8_t (*bus_write)(uint8_t, uint8_t, uint8_t *, uint8_t)
#define BME280_RD_FUNC_PTR int8_t (*bus_read)(uint8_t, uint8_t, uint8_t *, uint8_t)
...
/**************************************************************/
// FUNCTION FOR INTIALIZATION UNCOMPENSATED PRESSURE, TEMPERATURE AND HUMIDITY
/**************************************************************/
/*!
 * @brief This API used to read uncompensated pressure,temperature and humidity
 *  @param  v_uncomp_pressure_s32: The value of uncompensated pressure.
 *  @param  v_uncomp_temperature_s32: The value of uncompensated temperature
 *  @param  v_uncomp_humidity_s32: The value of uncompensated humidity.
 *	@return results of bus communication function
...
/**************************************************************/
// FUNCTION FOR TRUE UNCOMPENSATED PRESSURE, TEMPERATURE AND HUMIDITY
/**************************************************************/
/*!
 ...
 *	@retval -1 -> Error
 */
BME280_RETURN_FUNCTION_TYPE bme280_write_register(uint8_t v_addr_u8, uint8_t *v_data_u8, uint8_t v_len_u8);
 ...
 *	@retval -1 -> Error
 */
BME280_RETURN_FUNCTION_TYPE bme280_read_register(uint8_t v_addr_u8, uint8_t *v_data_u8, uint8_t v_len_u8);
